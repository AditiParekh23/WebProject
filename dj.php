...
$djTypes = [];
$djTypesQuery = "SELECT ID,Type FROM tbl_dj"; // Assuming you have a venue type table
$djTypesResult = $conn->query($djTypesQuery);
if ($djTypesResult->num_rows > 0) {
    while ($row = $djTypesResult->fetch_assoc()) {
        $djTypes[] = $row;
    }
}
                    ...
                    <div class="col-md-3 sidebar-wrapper">
                        <div class="sidebar">
                            ...
                            <div id="visible-venue-types">
                                <?php if (!empty($djTypes)): ?>
                                    <?php foreach (array_slice($djTypes, 0, 5) as $type): ?>
                            ...
                            <div id="hidden-venue-types" style="display: none;">
                                <?php foreach (array_slice($djTypes, 5) as $type): ?>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="venueType-<?php echo htmlspecialchars($type['ID']); ?>" name="filterVenueType[]" value="<?php echo htmlspecialchars($type['ID']); ?>">
                                        <label class="form-check-label" for="venueType-<?php echo htmlspecialchars($type['ID']); ?>"><?php echo htmlspecialchars($type['Type']); ?></label>
                                    </div>
                    ...
                    <div class="col-md-9 content-area">
                        <div class="row">
                            <div class="col-md-12 search-box">
                                <input type="text" id="search" placeholder="Search for DJ..." aria-label="Search for caterers">
                                    ...
                                    <div class="col-md-4"> <!-- Bootstrap grid column -->
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="dj_book.php?vendor_id=<?php echo $item['VendorID']; ?>&dj_detail_id=<?php echo $item['DJDetailID']; ?>" class="btn btn-primary">
                                                    Book Now
                                                </a>
                                            </div>
                                        </div>
