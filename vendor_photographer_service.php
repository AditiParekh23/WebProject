...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    echo "No details found for Photography.";
}
                        ...
                        <div class="col-12 d-flex">
                            <div class="card flex-fill" style="width: 100%; max-width: 1240px; margin: auto; padding: 25px;">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Photography Services</h5>
                                    <a href="vendor_add_photographer.php" class="btn btn-success">Add</a>
                                </div>
                                <table class="table table-hover my-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Package Name</th>
                                            <th class="d-none d-md-table-cell">Package Details</th>
                                    ...
                                    <tbody>
                                        <?php if (!empty($photographies)): ?>
                                            <?php foreach ($photographies as $photo): ?>
                                                <tr>
                                                    <td><?php echo htmlspecialchars($photo['PhotographyType']); ?></td>
                                                    <td><?php echo htmlspecialchars($photo['PackageName']); ?></td>
                                                    <td class="d-none d-md-table-cell"><?php echo htmlspecialchars($photo['PackageDetails']); ?></td>
                                                    <td class="d-none d-md-table-cell"><?php echo htmlspecialchars($photo['Price']); ?></td>
                                                    <td class="d-none d-md-table-cell"><?php echo htmlspecialchars($photo['BookingPrice']); ?></td>
                                                    <td class="d-none d-md-table-cell">
                                                        <img src="uploads/vendor_images/<?php echo htmlspecialchars($photo['DisplayImg']); ?>" alt="Image" />
                                                    </td>
                                                    <td class="action-buttons d-none d-md-table-cell">
                                                        <a href="vendor_edit_photographer.php?id=<?php echo $photo['PhotographyID']; ?>">
                                                            <i class="fa-solid fa-pen-to-square" style="font-size: 20px;"></i>
                                                        </a>
                                                        <a href="vendor_del_photographer.php?id=<?php echo $photo['PhotographyID']; ?>">
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="7">No details found for Photography.</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
