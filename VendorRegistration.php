...
if (isset($_POST['submit'])) {
    ...
    //if (!preg_match("/^([0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]Z[0-9])$/", $gst)) {
      //  $error_message .= "Invalid GST Number<br>";
    //}
    ...
    if (!empty($error_message)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($password == $cpassword) {
                ...
                header("Location: vendorverification.php");
                exit();
            } else {
                                ...
                                <div class="popup_box">
                                    <div class="popup_inner">
                                        ...
                                        <form method="POST">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <input type="text" required pattern="[A-Za-z\s]+" placeholder="Your Name" name="name">
                                                </div>

                                                <div class="col-xl-12">
                                                    <input type="email" required placeholder="Email" pattern="^[^@\s]+@[^@\s]+\.(com)$" name="email">
                                                </div>
                                                <div class="col-xl-12">
                                                    <input type="text" name="contact" pattern="[6-9][0-9]{9}" title="Enter 10 digits only." placeholder="Contact Number" required>
                                                </div>
                                                <div class="col-xl-12" required>
                                                    <select class="form-select wide" id="default-select" name="service">
                                                ...
                                                <div class="col-xl-12" required>
                                                    <select class="form-select wide" id="default-select" name="area">
