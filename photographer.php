...
$PhotographyType = [];
$PhotographyTypeQuery = "SELECT ID,PhotographyType FROM  tbl_photography"; // Assuming you have a venue type table
$PhotographyTypeResult = $conn->query($PhotographyTypeQuery);
if ($PhotographyTypeResult->num_rows > 0) {
    while ($row = $PhotographyTypeResult->fetch_assoc()) {
        $PhotographyType[] = $row;
    }
}
                    ...
                    <div class="col-md-3 sidebar-wrapper">
                        <div class="sidebar">
                            ...
                            <div id="visible-venue-types">
                                <?php if (!empty($PhotographyType)): ?>
                                    <?php foreach (array_slice($PhotographyType, 0, 5) as $type): ?>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="venueType-<?php echo htmlspecialchars($type['ID']); ?>"><?php echo htmlspecialchars($type['PhotographyType']); ?></label>
                                        </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
                            ...
                            <div id="hidden-venue-types" style="display: none;">
                                <?php foreach (array_slice($PhotographyType, 5) as $type): ?>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="venueType-<?php echo htmlspecialchars($type['ID']); ?>" name="filterVenueType[]" value="<?php echo htmlspecialchars($type['ID']); ?>">
                                        <label class="form-check-label" for="venueType-<?php echo htmlspecialchars($type['ID']); ?>"><?php echo htmlspecialchars($type['PhotographyType']); ?></label>
                                    </div>
                    ...
                    <div class="col-md-9 content-area">
                        <div class="row">
                            <div class="col-md-12 search-box">
                                <input type="text" id="search" placeholder="Search for Photographers..." aria-label="Search for caterers">
                                    ...
                                    <div class="col-md-4"> <!-- Bootstrap grid column -->
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="photo_book.php?vendor_id=<?php echo htmlspecialchars($item['VendorID']); ?>&photographer_detail_id=<?php echo htmlspecialchars($item['PhotographerDetailID']); ?>" class="btn btn-primary">
                                                    Book Now
                                                </a>
